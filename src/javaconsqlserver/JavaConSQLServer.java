...
public class JavaConSQLServer implements ActionListener
{
    // Declara componentes
    ...
    public static void criaGUI()
    {
        ...
        JavaConSQLServer conectar = new JavaConSQLServer();
    ...
    public void conectar(String banco, String login, String senha) {
        try
        {
            ...
            String URL =  "jdbc:sqlserver://ASUS\\SQLSERVER:1433;databaseName=" + banco +
    ...
    public void actionPerformed(ActionEvent arg0)
    {
       // Verfica tamanho da senha
        ...
        else
        {
            ...
            //Cria conexão
            JavaConSQLServer conecta= new JavaConSQLServer();
